...
ln -sf ./geoschem_config_b04.yml geoschem_config.yml
ln -sf ./HEMCO_Config_b04.rc HEMCO_Config.rc
ln -sf ./HISTORY_b01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/log_gc_b04
#./gcclassic --dryrun > ./logs/Baseline/log_gc_b04_dryrun
# Clean up:
unset id
unset nodename
