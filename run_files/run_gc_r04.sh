...
ln -sf ./geoschem_config_r04.yml geoschem_config.yml
ln -sf ./HEMCO_Config_r04.rc HEMCO_Config.rc
ln -sf ./HISTORY_r04.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Rockets/log_gc_r04
#./gcclassic --dryrun > ./logs/Rockets/log_gc_r04_dryrun
