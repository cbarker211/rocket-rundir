...
ln -sf ./geoschem_config_r03.yml geoschem_config.yml
ln -sf ./HEMCO_Config_r03.rc HEMCO_Config.rc
ln -sf ./HISTORY_r01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Rockets/log_gc_r03
#./gcclassic --dryrun > ./logs/Rockets/log_gc_r03_dryrun
# Clean up:
unset id
unset nodename
