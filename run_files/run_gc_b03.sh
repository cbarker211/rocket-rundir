...
# Set up dependencies:
ln -sf ./HEMCO_Config.rc.gmao_metfields_b01 HEMCO_Config.rc.gmao_metfields
ln -sf ./species_database_alumina.yml species_database.yml
ln -sf ./geoschem_config_b03.yml geoschem_config.yml
ln -sf ./HEMCO_Config_b03.rc HEMCO_Config.rc
ln -sf ./HISTORY_b01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/log_gc_b03
#./gcclassic --dryrun > ./logs/Baseline/log_gc_b03_dryrun
# Clean up:
unset id
unset nodename
