...
# Set up dependencies:
ln -sf ./HEMCO_Config.rc.gmao_metfields_co2check_noreaddyn HEMCO_Config.rc.gmao_metfields
ln -sf ./species_database_alumina.yml species_database.yml
ln -sf ./geoschem_config_co2check_withoutsa.yml geoschem_config.yml
ln -sf ./HEMCO_Config_co2check_withoutsa.rc HEMCO_Config.rc
ln -sf ./HISTORY_co2check_withoutsa.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/co2check/log_gc_co2check_withoutsa
#./gcclassic --dryrun > ./logs/co2check/log_gc_co2check_withoutsa_dryrun
# Clean up:
unset id
unset nodename
