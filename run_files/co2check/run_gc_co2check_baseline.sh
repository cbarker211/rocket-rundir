...
ln -sf ./geoschem_config_co2check_baseline.yml geoschem_config.yml
ln -sf ./HEMCO_Config_co2check_baseline.rc HEMCO_Config.rc
ln -sf ./HISTORY_co2check_baseline.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/co2check/log_gc_co2check_baseline
#./gcclassic --dryrun > ./logs/co2check/log_gc_co2check_baseline_dryrun
# Clean up:
unset id
unset nodename
