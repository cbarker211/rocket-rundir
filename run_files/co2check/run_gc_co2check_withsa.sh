...
ln -sf ./geoschem_config_co2check_withsa.yml geoschem_config.yml
ln -sf ./HEMCO_Config_co2check_withsa.rc HEMCO_Config.rc
ln -sf ./HISTORY_co2check_withsa.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/co2check/log_gc_co2check_withsa
#./gcclassic --dryrun > ./logs/co2check/log_gc_co2check_withsa_dryrun
# Clean up:
unset id
unset nodename
