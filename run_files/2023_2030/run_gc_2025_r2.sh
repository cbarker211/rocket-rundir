...
ln -sf ./HEMCO_Config_2025_r2.rc HEMCO_Config.rc
ln -sf ./HISTORY_2025_r1.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Rockets/2025/log_gc_2025_r2
#./gcclassic --dryrun > ./logs/Rockets/2025/log_gc_2025_r2_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/Rockets/2025
