...
# Set up dependencies:
ln -sf ./HEMCO_Config.rc.gmao_metfields_r HEMCO_Config.rc.gmao_metfields
ln -sf ./species_database_alumina.yml species_database.yml
ln -sf ./geoschem_config_rrtmg_r_instant.yml geoschem_config.yml
ln -sf ./HEMCO_Config_2029_rrtmg_r.rc HEMCO_Config.rc
ln -sf ./HISTORY_2029_rrtmg_r.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Rockets/2029/rrtmg/log_gc_20291201_r_instant
#./gcclassic --dryrun > ./logs/Rockets/2029/rrtmg/log_gc_20291201_r_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/Rockets/2029/rrtmg_instant
