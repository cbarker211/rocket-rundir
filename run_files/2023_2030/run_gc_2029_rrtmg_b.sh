...
# Set up dependencies:
ln -sf ./HEMCO_Config.rc.gmao_metfields_b HEMCO_Config.rc.gmao_metfields
ln -sf ./species_database_alumina.yml species_database.yml
ln -sf ./geoschem_config_rrtmg_b.yml geoschem_config.yml
ln -sf ./HEMCO_Config_2029_rrtmg_b.rc HEMCO_Config.rc
ln -sf ./HISTORY_2029_rrtmg_b.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/2029/rrtmg/log_gc_20291201_b
#./gcclassic --dryrun > ./logs/Baseline/2029/rrtmg/log_gc_20291201_b_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/Baseline/2029/rrtmg
