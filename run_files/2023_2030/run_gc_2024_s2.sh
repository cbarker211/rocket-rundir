...
ln -sf ./HEMCO_Config_2024_s2.rc HEMCO_Config.rc
ln -sf ./HISTORY_2024_s1.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/SMC/2024/log_gc_2024_s2
#./gcclassic --dryrun > ./logs/SMC/2024/log_gc_2024_s2_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/SMC/2024
