...
ln -sf ./HEMCO_Config_2029_rrtmg_s.rc HEMCO_Config.rc
ln -sf ./HISTORY_2029_rrtmg_s.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/SMC/2029/rrtmg/log_gc_20291201_s_instant
#./gcclassic --dryrun > ./logs/SMC/2029/rrtmg/log_gc_20291201_s_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/SMC/2029/rrtmg_instant
