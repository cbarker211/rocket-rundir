...
ln -sf ./geoschem_config_2023_b2.yml geoschem_config.yml
ln -sf ./HEMCO_Config_2029_b2.rc HEMCO_Config.rc
ln -sf ./HISTORY_2029_b1.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/2029/log_gc_2029_b2
#./gcclassic --dryrun > ./logs/Baseline/2029/log_gc_2029_b2_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/Baseline/2029
