...
ln -sf ./HEMCO_Config_2027_b2.rc HEMCO_Config.rc
ln -sf ./HISTORY_2027_b1.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/2027/log_gc_2027_b2
#./gcclassic --dryrun > ./logs/Baseline/2027/log_gc_2027_b2_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/Baseline/2027
