...
ln -sf ./HEMCO_Config_2026_b2.rc HEMCO_Config.rc
ln -sf ./HISTORY_2026_b1.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/2026/log_gc_2026_b2
#./gcclassic --dryrun > ./logs/Baseline/2026/log_gc_2026_b2_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/Baseline/2026
