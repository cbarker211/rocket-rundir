...
ln -sf ./HEMCO_Config_2024_b2.rc HEMCO_Config.rc
ln -sf ./HISTORY_2024_b1.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/2024/log_gc_2024_b2
#./gcclassic --dryrun > ./logs/Baseline/2024/log_gc_2024_b2_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/Baseline/2024
