...
ln -sf ./geoschem_config_r06.yml geoschem_config.yml
ln -sf ./HEMCO_Config_r06.rc HEMCO_Config.rc
ln -sf ./HISTORY_r01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Rockets/log_gc_r06
#./gcclassic --dryrun > ./logs/Rockets/log_gc_r06_dryrun
# Clean up:
unset id
unset nodename
