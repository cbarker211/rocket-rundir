...
ln -sf ./geoschem_config_r07.yml geoschem_config.yml
ln -sf ./HEMCO_Config_r07.rc HEMCO_Config.rc
ln -sf ./HISTORY_r01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Rockets/log_gc_r07
#./gcclassic --dryrun > ./logs/Rockets/log_gc_r07_dryrun
# Clean up:
unset id
unset nodename
