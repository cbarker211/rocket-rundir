...
# Set up dependencies:
ln -sf ./HEMCO_Config.rc.gmao_metfields_b02 HEMCO_Config.rc.gmao_metfields
ln -sf ./species_database_alumina.yml species_database.yml
ln -sf ./geoschem_config_b08.yml geoschem_config.yml
ln -sf ./HEMCO_Config_b08.rc HEMCO_Config.rc
ln -sf ./HISTORY_b01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/log_gc_b08
#./gcclassic --dryrun > ./logs/Baseline/log_gc_b08_dryrun
# Clean up:
unset id
unset nodename
