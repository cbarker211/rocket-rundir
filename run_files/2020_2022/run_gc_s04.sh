...
ln -sf ./geoschem_config_s04.yml geoschem_config.yml
ln -sf ./HEMCO_Config_s04.rc HEMCO_Config.rc
ln -sf ./HISTORY_s04.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/SMC/log_gc_s04
#./gcclassic --dryrun > ./logs/SMC/log_gc_s04_dryrun
