...
ln -sf ./geoschem_config_b07.yml geoschem_config.yml
ln -sf ./HEMCO_Config_b07.rc HEMCO_Config.rc
ln -sf ./HISTORY_b01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/Baseline/log_gc_b07
#./gcclassic --dryrun > ./logs/Baseline/log_gc_b07_dryrun
# Clean up:
unset id
unset nodename
