...
ln -sf ./geoschem_config_s02.yml geoschem_config.yml
ln -sf ./HEMCO_Config_s02.rc HEMCO_Config.rc
ln -sf ./HISTORY_s01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/SMC/log_gc_s02
#./gcclassic --dryrun > ./logs/SMC/log_gc_s02_dryrun
