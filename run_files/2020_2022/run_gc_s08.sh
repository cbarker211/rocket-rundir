...
ln -sf ./geoschem_config_s08.yml geoschem_config.yml
ln -sf ./HEMCO_Config_s08.rc HEMCO_Config.rc
ln -sf ./HISTORY_s04.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/SMC/log_gc_s08
#./gcclassic --dryrun > ./logs/SMC/log_gc_s08_dryrun

# Move HEMCO restart file.
mv ./Restarts/HEMCO_restart.* ./Restarts/SMC
