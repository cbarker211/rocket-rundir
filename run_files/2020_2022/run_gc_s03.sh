...
ln -sf ./geoschem_config_s03.yml geoschem_config.yml
ln -sf ./HEMCO_Config_s03.rc HEMCO_Config.rc
ln -sf ./HISTORY_s01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/SMC/log_gc_s03
#./gcclassic --dryrun > ./logs/SMC/log_gc_s03_dryrun
