...
ln -sf ./geoschem_config_s01.yml geoschem_config.yml
ln -sf ./HEMCO_Config_s01.rc HEMCO_Config.rc
ln -sf ./HISTORY_s01.rc HISTORY.rc


# Pipe output to log file only:
./gcclassic > ./logs/SMC/log_gc_s01
#./gcclassic --dryrun > ./logs/SMC/log_gc_s01_dryrun
